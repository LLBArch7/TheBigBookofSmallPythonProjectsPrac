"""Digital Stream, by Al Sweigart al@inventwith python.com
A screensaver in the style of The Matrix movie's visuals.
Vieew this code at https:/nostarch.com/big-book-small-python-projects
...
STREAM_CHARS = ['LL', 'B'] # (!) Try changing this to other characters.
...
print('Digital Steam, by Al Sweigart al@inventwithpython.com')
