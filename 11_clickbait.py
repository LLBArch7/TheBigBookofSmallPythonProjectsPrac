...
A clickbait headline generator for your soulless contect farm website.
View this code at https://nostarch.com/big/big-book-small-python-projects
...
NOUNS = ['Athlete', 'Clown', 'Shovel', 'Paleo Diet', 'Doctor', 'Parent',
         'Dog', 'Chicken', 'Robot', 'Video Game', 'Avocado',
...
def main():
    ...
    print('By Al Sweigart all@inventwithpython.com')
    print()
...
def generateReasonsWhyHeadline():
    ...
    pluralNoun = random.choice(NOUNS) + 's'
    # number2 should be no larger that number1:
