...
# Then save this file as perioditable.csv.
# Or download this csv file from https://invpy.com/periodictable.csv (broken link 27JAN2024)
...
for line in elements:
    ...
    for key, value in element.items():
        # Remove the [roman numerals] text:
