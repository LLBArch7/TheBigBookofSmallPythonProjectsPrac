...
CATEGORY  = 'Animals'
WORDS = 'ANT BABOON BADGER BAT BEAR BEAVER CAMEL CLAM COBRA COUGAR COYOTE CROW DEER DOG DONKEY DUCK EAGLE FERRET FOX FROG GOAT GOOSE HAWK LION LIZARD LLAMA MOLE MONKEY MOOSE MOUSE MULE NEWT OTTER OWL PANDA PARROT PIGEON PYTHON RABBIT RAM RAT RAVEN RHINO SALMON SEAL SHARK SHEEP SKUNK SLOTH SNAKE SPIDER STORK SWAN TIGER TOAD TROUT TURKEY TURTLE WEASEL WHALE WOLF WOMBAT ZEBRA'.split()
...
def main():
    ...
    missedLetters = [] # List of incorrect guesses.
    correctLetters = [] # List of correct letter guesses.
    secretWord = random.choice(WORDS) # The work the player must guess.
...
def drawHangman(missedLetters, correctLetters, secretWord):
    ...
    # Show the secret work with spaces in between each letter:
    print(' '.join(blanks))
    
    
def getPlayerGuess(alreadyGuessed):
    """Returns the lette the player entered. This function makes sure
