...
Examples:
    3d6 rolls three 6-sided die, and adds 2
    1d10+2 rolls one 10-sided die, and adds 2
    2d38-1 rolls two 38-side die, and subtracts 1
    QUITS quits the program
''')
...
while True: # Main program loop:
    try:
        ...
        if modIndex == -1:
            ...
            if diceStr[modIndex]  == '-':
                # Change the modification amount the negative:
                modAmount = -modAmount
        ...
        print('Input was invalid beacuse: ' + str(exc))
