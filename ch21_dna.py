...
ROWS = [
    #123456789 <- Use this to measure the number oof spaces:
    '         ##', # Index 0 has no {}.
    '        #{}-{}#',
    '       #{}---{}#',
    '      #{}-----{}#',
...
try:
    print('DNA Animamtion, by Al Sweigart al@inventwithpython.com')
    print('Press Ctrt-C to quit...')
    time.sleep(2)
    rowIndex = 0
    ...
    while True: # Main program loop.
        ...
        # Row indexes 0 and 9 don't have nucleatides:
