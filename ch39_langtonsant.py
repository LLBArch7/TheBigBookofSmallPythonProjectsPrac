...
# newline automatically, so redue the width by one:
WIDTH -= 1
HEIGHT -= 1 # Adjustment for the quit message at the bottom.

NUMBER_OF_ANTS = 10 # (!) Try chanigng this to 1 pr 50.
...
# (!) Try changing these colors to one of the 'black', 'red', 'green',
...
def displayBoard(board, ants, changedTiles):
    """Display the board and ants on the screen. The changedTiles
