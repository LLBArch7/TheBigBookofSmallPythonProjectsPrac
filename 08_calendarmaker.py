...
Create a monthly calendars, saved to a text file and fir for printing.
...
while True: # Loop to get a year from the user.
    ...
    print('Please enter a numeric year like 2024') # Look for way to make current year, probably {} usage.
    continue
...
while True: # Loop to get a month from the user.
    ...
    if not response.isdecimal():
        print('Please enter a numeric month, like 2 for February.')
        continue
...
def getCalendarFor(year,month):
    ...
    # Add the days for the week labels to the calendar:
    ...
    # Roll back currentDate until if is Sunday. (weekday() returns 6
    # for Sunday, not 0.)
    ...
    while True: # Loop over each week in the month.
        ...
        #dayNumberRow is the row with teh day number labels:
        dayNumberRow = ''
        for i in range(7):
