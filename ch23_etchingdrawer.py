...
An art program that draws a line around the screen using the
...
while True: # Main program loop.
    ...
    if response == 'QUIT':
        ...
        print('Enter W, A, S, and D characters to move the curson and')
    ...
    for command in response:
        ...
        if canvas == {}:
            if command in ('W', 'S'):
                ...
                # Make the first line a verticle one:
        ...
        if command == 'W' and cursorY > 0:
            ...
            # If the cursor doesn't move beacuse it would have moved off
